            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        <form id="quickForm" method="POST" action="{{ route('proses-ubah-buku') }}">
                            <div class="card-body">
                                @csrf
                                <div class="form-group">
                                    ...
                                    <input type="text" name="judul_buku" class="form-control" id="judul_buku"
                                        aria-describedby="judul_buku" value="{{ $buku->judul_buku }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tahun_terbit" class="form-control " id="tahun_terbit"
                                        aria-describedby="tahun_terbit" value="{{ $buku->tahun_terbit }}">
                                </div>

                                <div class="form-group">
                                    <label for="jumlah_buku" class="form-label">Jumlah Buku</label>
                                    <input type="text" name="jumlah_buku" class="form-control" id="jumlah_buku"
                                        aria-describedby="jumlah_buku" value="{{ $buku->jumlah_buku }}">
                                </div>
