            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <form id="quickForm" method="POST" action="{{ route('proses-ubah-penerbit') }}">
                            <div class="card-body">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_penerbit" class="form-control" id="nama_penerbit"
                                        aria-describedby="nama_penerbit" value="{{ $penerbit->nama_penerbit }}">

                                </div>
                                <div class="form-group">
                                    <label for="alamat" class="form-label">Alamat</label>
                                    <input type="text" name="alamat" class="form-control" id="alamat"
                                        aria-describedby="alamat" value="{{ $penerbit->alamat }}">
                                </div>
                                <div class="form-group">
                                    <label for="no_telepon" class="form-label">Nomor Telepon</label>
                                    <input type="text" name="no_telepon" class="form-control" id="no_telepon"
                                        aria-describedby="no_telepon" value="{{ $penerbit->no_telepon }}">
                                </div>
                            </div>
